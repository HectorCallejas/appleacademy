<?php
	...
	if(!empty($_POST))
	{
		...
		{			
			...
			$url = 'http://localhost/apple/login/cambia_pass.php?user_id='.$user_id.'&token='.$token;
			
			$asunto = 'Recuperar Password - Apple Academy';
			...
			<div id="loginbox" style="margin-top:50px;" class="mainbox col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2">                    
				<div class="panel panel-info" >
					<div class="panel-heading">
						<div class="panel-title">Recuperacion de contraseña </div>
					...
					<div style="padding-top:30px" class="panel-body" >
						...
						<form id="loginform" class="form-horizontal" role="form" action="<?php $_SERVER['PHP_SELF'] ?>" method="POST" autocomplete="off">
							...
							<div style="margin-bottom: 25px" class="input-group">
								...
								<input id="email" type="email" class="form-control" name="email" placeholder="Digite tu email" required>                                        
							</div>
